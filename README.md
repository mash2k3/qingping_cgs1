# Qingping Pro AQM component

**Note!** ⚠️** Before you begin you must enable mqtt on the device. Follow the instructions provided by GreyEarl below [here](https://github.com/mash2k3/qingping_cgs1/blob/main/enableMQTT.md).**
